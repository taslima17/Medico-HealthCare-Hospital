...
const About = () => {
    return (
        <div className="container">
            ...
            <button style={{ background: "rgb(52, 52, 236)", color: "white", fontWeight: "600", borderRadius: "20px", padding: " 15px", border: "0", marginTop: "40px" }}>Choose Mayo Clinic For Health Care</button>
        </div>
    );
};
